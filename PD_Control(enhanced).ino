...
#define PIN_LED 9
// Distance sensor
#define _DIST_ALPHA 0.2  //[3099] EMA 필터링을 위한 alpha 값
               // [3108] 0~1 사이의 값

// Servo range
#define _DUTY_MIN 1130     //[3100] 최저 서보 위치
#define _DUTY_NEU 1530     //[3100] 중립 서보 위치
#define _DUTY_MAX 1930     //[3100] 최대 서보 위치


// Servo speed control
#define _SERVO_ANGLE 30.0 // [3114] 서보각도
#define _SERVO_SPEED 160.0 //[3104] 서보속도
...
// PID parameters
#define _KP 2 // [3103] KP값은 개인이 설정 난 2다
#define _KD 18
...
////////////////////
  ...
  // get a distance reading from the distance sensor
     ...
     dist_ema = ir_distance_filtered2(dist_ema);
     dist_ema = ir_distance_filtered3(dist_ema);
     dist_ema = ir_distance_filtered4(dist_ema);
      // [3099] dist_ema?
...
float ir_distance_filtered2(float aa){ // return value unit: mm
  dist_raw=aa;
  return _DIST_ALPHA * dist_raw + (1 - _DIST_ALPHA) * dist_ema;
} 
float ir_distance_filtered3(float bb){ // return value unit: mm
  dist_raw=bb;
  return _DIST_ALPHA * dist_raw + (1 - _DIST_ALPHA) * dist_ema;
} 
float ir_distance_filtered4(float cc){ // return value unit: mm
  dist_raw=cc;
  return _DIST_ALPHA * dist_raw + (1 - _DIST_ALPHA) * dist_ema;
} 
